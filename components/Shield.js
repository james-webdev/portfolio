    ...
    <div className="flex justify-center items-center lg:flex-col">
      <div className="" style={{ height: 80 }}>
        <Sparkles className="w-20">
          ...
          >
            <g>
              <path fill="#162862" d="M27.285,61.902c0,0,55.165,13.791,229.279-62.061v267.403H65.19C48.895,212.17,35.522,146.07,27.285,61.902z" />
              <path fill="#46A4CB" d="M256.564,267.244v244.597C231.977,500.92,127.329,477.25,65.19,267.244H256.564z" />
              <path fill="#215D9E" d="M485.844,61.902c0,0-55.165,13.791-229.279-62.061v267.403h191.374C464.234,212.17,477.606,146.07,485.844,61.902z" />
